...
export default function ManagerLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Post Scholarship', href: '/manager/post', icon: Plus, current: pathname === '/manager/post' },
    { name: 'Manage Scholarships', href: '/manager/manage', icon: Edit, current: pathname === '/manager/manage' },
    { name: 'Statistics', href: '/manager/statistics', icon: BarChart3, current: pathname === '/manager/statistics' },
    { name: 'Bulk Import', href: '/manager/import', icon: Upload, current: pathname === '/manager/import' },
  ];
  ...
  const getCurrentUser = () => {
    if (typeof window !== 'undefined') {
      ...
      return user ? JSON.parse(user) : { name: 'Manager', email: 'manager@scholarsrus.com' };
    }
    return { name: 'Manager', email: 'manager@scholarsrus.com' };
  };
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Manager Portal</span>
            </div>
