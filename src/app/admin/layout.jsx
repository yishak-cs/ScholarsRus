...
export default function AdminLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Manager Management', href: '/admin/managers', icon: UserCheck, current: pathname === '/admin/managers' },
    { name: 'Statistics & Analytics', href: '/admin/analytics', icon: BarChart3, current: pathname === '/admin/analytics' },
    { name: 'System Activity', href: '/admin/activity', icon: Activity, current: pathname === '/admin/activity' },
  ...
  const getCurrentUser = () => {
    if (typeof window !== 'undefined') {
      ...
      return user ? JSON.parse(user) : { name: 'Admin', email: 'admin@scholarsrus.com', role: 'admin' };
    }
    return { name: 'Admin', email: 'admin@scholarsrus.com', role: 'admin' };
  };
